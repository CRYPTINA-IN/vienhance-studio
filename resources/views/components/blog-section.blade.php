        ...
        <div class="row section-row align-items-center">
            ...
            <div class="col-lg-4">
                ...
                <div class="section-btn wow fadeInUp" data-wow-delay="0.2s">
                    <a href="#" class="btn-default">view all post</a>
                </div>
                <!-- Section Button End -->
            </div>
        </div>
                ...
                <div class="post-item wow fadeInUp">
                    ...
                    <div class="post-item-body">
                        ...
                        <div class="post-item-content">
                            <h2><a href="#">The Role of Color Psychology in Branding</a></h2>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="post-item wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="post-item-body">
                        <!-- Post Item Content Start -->
                        <div class="post-item-content">
                            <h2><a href="#">How color Shades and Brand Identity</a></h2>
                        </div>
                        <!-- Post Item Content End -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="post-item wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="post-item-body">
                        <!-- Post Item Content Start -->
                        <div class="post-item-content">
                            <h2><a href="#">Breaking Down the Design Process From Concept</a></h2>
                        </div>
                        <!-- Post Item Content End -->
